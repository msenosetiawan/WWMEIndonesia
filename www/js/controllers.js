angular.module("wwme_indonesia.controllers", [])
		...
		confirmPopup.then(function (close){
			if(close){
				localforage.keys().then(function(keys) {
					...
					$state.go("wwme_indonesia.dashboard");
				}).catch(function(err) {
					$state.go("wwme_indonesia.dashboard");
				});
			}
...
.controller("categoriesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://wwmeindonesia.org/wp-json/wp/v2/categories?per_page=100";
	// TODO: categoriesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://wwmeindonesia.org/wp-json/wp/v2/categories?per_page=100&callback=JSON_CALLBACK";
...
// TODO: download_pdfCtrl --|-- 
.controller("download_pdfCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: download_pdfCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: download_pdfCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: download_pdfCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: download_pdfCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `download_pdf` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: e_relasiCtrl --|-- 
.controller("e_relasiCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: e_relasiCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: e_relasiCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: e_relasiCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: e_relasiCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `e_relasi` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: erelasiCtrl --|-- 
.controller("erelasiCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: erelasiCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: erelasiCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: erelasiCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: erelasiCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `erelasi` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: event_meCtrl --|-- 
.controller("event_meCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: event_meCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: event_meCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: event_meCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: event_meCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `event_me` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: form_data_wwme_indonesiaCtrl --|-- 
.controller("form_data_wwme_indonesiaCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: form_data_wwme_indonesiaCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: form_data_wwme_indonesiaCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: form_data_wwme_indonesiaCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// Form Request
	//data_wwme_indonesia
	$scope.form_data_wwme_indonesia= {};
	// TODO: form_data_wwme_indonesiaCtrl --|-- $scope.submitData_wwme_indonesia
	$scope.submitData_wwme_indonesia = function(){
		// animation loading 
		$ionicLoading.show();
		...
		$http({
				method:"POST",
				url: "#",
				data: $httpParamSerializer($scope.form_data_wwme_indonesia),  // pass in data as strings
			...
			.then(function(response) {
				...
				$timeout(function() {
					...
					var alertPopup = $ionicPopup.alert({
						...
						// clear input
						$scope.form_data_wwme_indonesia.Nama_Anda = "";
						$scope.form_data_wwme_indonesia.Nama_Pasangan = "";
					}
			}, 500);
		});
	};
	...
	// TODO: form_data_wwme_indonesiaCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `form_data_wwme_indonesia` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("pengurus_relasiCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `pengurus_relasi` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("post_bookmarkCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: post_bookmarkCtrl --|-- Database for Cart/Bookmark
	// TODO: post_bookmarkCtrl --|-- $scope.loadDbVirtualTag
	 
	$scope.loadDbVirtualTag = function(){
		$ionicLoading.show();
		//post_bookmark
		$scope.tag_bookmark = []; 
		localforage.getItem("tag_bookmark", function(err,dbVirtual){
			if(dbVirtual === null){
				$scope.tag_bookmark = []; 
			}else{
				try{
					$scope.tag_bookmark = JSON.parse(dbVirtual); 
					$rootScope.item_in_virtual_table_tag = $scope.tag_bookmark.length;
				}catch (e){
					$scope.tag_bookmark = []; 
				}
			}
	...
	$scope.$on("$ionicView.enter", function (){
		$scope.loadDbVirtualTag();
	});
	// TODO: post_bookmarkCtrl --|-- $scope.clearDbVirtualTag
	$scope.clearDbVirtualTag = function(){
					$rootScope.item_in_virtual_table_tag = 0;
		localforage.setItem("tag_bookmark",[]);
		$timeout(function(){
			$scope.loadDbVirtualTag();
		},200);
	};
	// TODO: post_bookmarkCtrl --|-- $scope.removeDbVirtualTag
	$scope.removeDbVirtualTag = function(itemId){
		var virtual_items = [];
		var last_items = $scope.tag_bookmark;
		for(var z=0;z<last_items.length;z++){
			if(itemId!==last_items[z].id){
				virtual_items.push(last_items[z]);
			}
		}
		localforage.setItem("tag_bookmark",JSON.stringify(virtual_items));
		$timeout(function(){
			$scope.loadDbVirtualTag();
		},200);
	};
...
.controller("post_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://wwmeindonesia.org/wp-json/wp/v2/posts/" + itemID;
	// TODO: post_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://wwmeindonesia.org/wp-json/wp/v2/posts/" + itemID + "?callback=JSON_CALLBACK";
...
.controller("postsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://wwmeindonesia.org/wp-json/wp/v2/posts/?categories=-1&per_page=15&page=1";
	// TODO: postsCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://wwmeindonesia.org/wp-json/wp/v2/posts/?categories=-1&per_page=15&page=1&callback=JSON_CALLBACK";
...
var UriListing = "https://wwmeindonesia.org/wp-json/wp/v2/posts?categories=-1&per_page=15";    
...
// TODO: tagCtrl --|-- 
.controller("tagCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: tagCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: tagCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: tagCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var form = {"uname":"demo","pwd":"demo"};
		$scope.form = {};
		var authPopup = $ionicPopup.show({
	...
	// TODO: tagCtrl --|-- $scope.addToVirtual
	$scope.addToDbVirtual = function(newItem){
		var is_already_exist = false ;
		// animation loading 
		$ionicLoading.show();
	...
	// TODO: tagCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "https://wwmeindonesia.org/wp-json/wp/v2/posts/?_embed&categories=&per_page=12&page=1";
	// TODO: tagCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://wwmeindonesia.org/wp-json/wp/v2/posts/?_embed&categories=&per_page=12&page=1&callback=JSON_CALLBACK";
	// TODO: tagCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash( $scope.fetchURL.replace(targetQuery,raplaceWithQuery));
	...
	localforage.getItem("data_tags_" + $scope.hashURL, function(err, get_tags){
		if(get_tags === null){
			data_tags =[];
		}else{
			data_tags = JSON.parse(get_tags);
			$scope.data_tags =JSON.parse( get_tags);
			$scope.tags = [];
			for(lastPush = 0; lastPush < 100; lastPush++) {
				if (angular.isObject(data_tags[lastPush])){
					$scope.tags.push(data_tags[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_tags.length === 0 ){
		$timeout(function() {
			...
			// TODO: tagCtrl --|-- $http.get
			$http.get(url_request,http_header).then(function(response) {
				data_tags = response.data;
				$scope.data_tags = response.data;
				// TODO: tagCtrl --|---------- set:localforage
				localforage.setItem("data_tags_" + $scope.hashURL, JSON.stringify(data_tags));
				$scope.tags = [];
				for(lastPush = 0; lastPush < 100; lastPush++) {
					if (angular.isObject(data_tags[lastPush])){
						$scope.tags.push(data_tags[lastPush]);
				...
				$timeout(function() {
					...
					// TODO: tagCtrl --|------ $http.jsonp
					$http.jsonp(url_request,http_header).success(function(data){
						data_tags = data;
						$scope.data_tags = data;
						$ionicLoading.hide();
						// TODO: tagCtrl --|---------- set:localforage
						localforage.setItem("data_tags_" + $scope.hashURL,JSON.stringify(data_tags));
						controller_by_user();
					...
					if(response.status ===401){
						// TODO: tagCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: tagCtrl --|------------ error:Message
						var data = { statusText:response.statusText, status:response.status };
						var alertPopup = $ionicPopup.alert({
							title: "Network Error" + " (" + data.status + ")",
							template: "An error occurred while collecting data.",
			...
			$timeout(function() {
				$ionicLoading.hide();
				controller_by_user();
				if(angular.isDefined($scope.data_tags.data)){
					if($scope.data_tags.data.status ===401){
						$scope.showAuthentication();
						return false;
					}
				}
	...
	// TODO: tagCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
var UriListing = "https://wwmeindonesia.org/wp-json/wp/v2/posts?_embed&categories=&per_page=12";    
if(!$scope.paging){$scope.paging=1;}
$scope.updatePaging=function(ev){
    if(ev === true){
        $scope.paging++;
    ...
    $timeout(function() {
        $scope.scrollTop();
			...
			console.log("%cerror: %cPage: `tag` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: tag_bookmarkCtrl --|-- 
.controller("tag_bookmarkCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: tag_bookmarkCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: tag_bookmarkCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: tag_bookmarkCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: tag_bookmarkCtrl --|-- Database for Cart/Bookmark
	// TODO: tag_bookmarkCtrl --|-- $scope.loadDbVirtualPost
	...
	// TODO: tag_bookmarkCtrl --|-- $scope.clearDbVirtualPost
	$scope.clearDbVirtualPost = function(){
					$rootScope.item_in_virtual_table_post = 0;
		localforage.setItem("post_bookmark",[]);
		$timeout(function(){
	...
	// TODO: tag_bookmarkCtrl --|-- $scope.removeDbVirtualPost
	$scope.removeDbVirtualPost = function(itemId){
		var virtual_items = [];
		var last_items = $scope.post_bookmark;
		for(var z=0;z<last_items.length;z++){
	...
	// TODO: tag_bookmarkCtrl --|-- Database for Cart/Bookmark
	// TODO: tag_bookmarkCtrl --|-- $scope.loadDbVirtualTag
	...
	// TODO: tag_bookmarkCtrl --|-- $scope.clearDbVirtualTag
	$scope.clearDbVirtualTag = function(){
					$rootScope.item_in_virtual_table_tag = 0;
		localforage.setItem("tag_bookmark",[]);
		$timeout(function(){
	...
	// TODO: tag_bookmarkCtrl --|-- $scope.removeDbVirtualTag
	$scope.removeDbVirtualTag = function(itemId){
		var virtual_items = [];
		var last_items = $scope.tag_bookmark;
		for(var z=0;z<last_items.length;z++){
	...
	// TODO: tag_bookmarkCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `tag_bookmark` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: tag_singlesCtrl --|-- 
.controller("tag_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: tag_singlesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: tag_singlesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: tag_singlesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: tag_singlesCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var form = {"uname":"demo","pwd":"demo"};
		$scope.form = {};
		var authPopup = $ionicPopup.show({
	...
	// TODO: tag_singlesCtrl --|-- $scope.addToVirtual(); //data single
	$scope.addToDbVirtual = function(newItem){
		if(typeof newItem.id === "undefined"){
			return false;
		}
		...
		localforage.getItem("tag_bookmark", function(err,dbVirtual){
			...
			$timeout(function(){
				$ionicLoading.hide();
				$rootScope.item_in_virtual_table_tag = virtual_items.length;
			},200);
		}).catch(function(err){
			virtual_items = [];
			virtual_items.push(newItem);
	...
	// Retrieving data
	var itemID = $stateParams.id;
	// TODO: tag_singlesCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "https://wwmeindonesia.org/wp-json/wp/v2/posts/" + itemID;
	// TODO: tag_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://wwmeindonesia.org/wp-json/wp/v2/posts/" + itemID + "?callback=JSON_CALLBACK";
	// TODO: tag_singlesCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash($scope.fetchURL);
	
	var current_item = [];
	localforage.getItem("data_tag_single_" + $scope.hashURL, function(err, get_datas){
		if(get_datas === null){
			current_item = [];
		}else{
			if(get_datas !== null){
	...
	if( current_item.length === 0 ){
		...
		// TODO: tag_singlesCtrl --|-- $http.get
		$http.get($scope.fetchURL,http_header).then(function(response) {
			// Get data single
			var datas = response.data;
			// TODO: tag_singlesCtrl --|---------- set:localforage
			localforage.setItem("data_tag_single_" + $scope.hashURL,JSON.stringify(datas));
			current_item = datas ;
		},function(data) {
					// Error message
					var alertPopup = $ionicPopup.alert({
		...
		// TODO: tag_singlesCtrl --|-- $scope.doRefresh
	$scope.doRefresh = function(){
		// Retrieving data
		var itemID = $stateParams.id;
		var current_item = [];
		...
		$http.get($scope.fetchURL,http_header).then(function(response) {
			...
			// Error message
		// TODO: tag_singlesCtrl --|---------- $http.jsonp
				$http.jsonp($scope.fetchURLp,http_header).success(function(response){
					// Get data single
					var datas = response;
			// TODO: tag_singlesCtrl --|---------- set:localforage
	...
	// TODO: tag_singlesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `tag_singles` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: tentang_kamiCtrl --|-- 
.controller("tentang_kamiCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: tentang_kamiCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: tentang_kamiCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: tentang_kamiCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: tentang_kamiCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `tentang_kami` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("usersCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://wwmeindonesia.org/wp-json/wp/v2/users/";
	// TODO: usersCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://wwmeindonesia.org/wp-json/wp/v2/users/?callback=JSON_CALLBACK";
